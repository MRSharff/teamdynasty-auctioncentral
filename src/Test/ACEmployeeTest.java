...
public class ACEmployeeTest {
	...
	public void testViewCalendar() {
		...
		Auction testAuction1 = new Auction ( testNPO1, new Date("7/15/2015"), new Date("7/16/2015"), testItemList1 );
		Auction testAuction2 = new Auction ( testNPO2, new Date("7/18/2015"), new Date("7/19/2015"), testItemList2 );
		Auction testAuction3 = new Auction ( testNPO3, new Date("10/27/2015"), new Date("10/28/2015"), testItemList3 );
		...
		// Setting Up the Entire Auction List Inside the Hash Map With the Months
