...
public class AuctionCentralMainView {
  ...
  public static final String ACTION_CALENDAR_CANCELED_MSG = "Exiting Monthly Calendar Method";
  
  public static final String ACTION_AUCTION_CANCELED_MSG = "Exiting Auction Details Method";
